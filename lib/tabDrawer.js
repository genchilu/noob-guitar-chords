...
function reDrawStringPosition(opt) {
	if(opt.fret_i > 0){ 
...
function reDrawStringWithFret(stringWithFret) {
	stringWithFret.forEach(function(fret, sting_i){
		reDrawStringPosition({'string_i': string_i, 'fret_i': fret_i});
	});
}